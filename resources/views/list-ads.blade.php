...
<section class="section-sm">
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="{{ route('annonces.detail') }}">
                <img src="{{ asset('front/images/products/products-1.jpg') }}" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="{{ route('annonces.detail') }}" class="font-weight-bold">11inch Macbook Air</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
                            <li class="list-inline-item"><a href="{{ route('annonces.detail') }}"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
                            <li class="list-inline-item"><a href="{{ route('annonces.detail') }}"><i class="fa fa-calendar"></i>26th December</a></li>
                        </ul>
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="{{ route('annonces.detail') }}">
                <img src="{{ asset('front/images/products/products-2.jpg') }}" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
                <div class="col-lg-6 col-md-10">
                    <div class="ad-listing-content">
                        <div>
                            <a href="{{ route('annonces.detail') }}" class="font-weight-bold">Study Table Combo</a>
                        </div>
                        <ul class="list-inline mt-2 mb-3">
                            <li class="list-inline-item"><a href="{{ route('annonces.detail') }}"> <i class="fa fa-folder-open-o"></i> Electronics</a></li>
                            <li class="list-inline-item"><a href="{{ route('annonces.detail') }}"><i class="fa fa-calendar"></i>26th December</a></li>
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="{{ route('annonces.detail') }}">
                <img src="{{ asset('front/images/products/products-3.jpg') }}" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
    ...
    <div class="row p-lg-3 p-sm-5 p-4">
        <div class="col-lg-4 align-self-center">
            <a href="{{ route('annonces.detail') }}">
                <img src="{{ asset('front/images/products/products-4.jpg') }}" class="img-fluid" alt="">
            </a>
        </div>
        <div class="col-lg-8">
            <div class="row">
